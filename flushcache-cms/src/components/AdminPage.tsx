  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <ul className="space-y-2 font-medium mb-10">
                <li>
                  <a href="/admin" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="GitLab API Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CloudFlare API</span>
                  </a>
                </li>
            </ul>
           <ul className="space-y-2 font-medium">
              ...
              <li>
                 <a href="/admin" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap">cloudflare</span>
      ...
      <div className="flex-1 p-6 bg-gray-50 dark:bg-gray-900">
        ...
        <p className="text-gray-600 dark:text-gray-300">This is the admin dashboard where you can manage users, view stats, and configure settings.</p>
      </div>
    </div>
  );
};
